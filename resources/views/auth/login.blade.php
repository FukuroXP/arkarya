...
<!-- Mirrored from designreset.com/cork/ltr/demo3/auth_login_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Apr 2021 07:23:57 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form">
                                ...
                                <p class="signup-link">Not registered ? <a href="/">Call the Police</a></p>
